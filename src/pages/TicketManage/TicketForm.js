...
export default class TicketForm extends React.Component {
  ...
  render() {
    const { action, detail } = this.props;
    const { mapVisible, mapAddress, ticketForm, ticketTimeArr } = this.state;
            ...
            <Col xs={24} sm={24} md={24} lg={14}>
              ...
              >
                <FormItem {...formItemLayout} label="展会名称">
                  ...
                  })(<Input autoComplete="off" allowClear={true} placeholder="请输入展会名称" />)}
                </FormItem>
                ...
                <FormItem {...formItemLayout} label="展会介绍" className={styles.ueditor}>
                  {getFieldDecorator('content', {
                    ...
                    <Ueditor height={250} content={detail.content} callback={this.editorCallback} />
                  )}
                </FormItem>
