...
@Form.create()
export default class FormActivity extends React.Component {
  constructor(props) {
    super(props)
    this.ajaxFlag = true
    this.state = {
  ...
  render() {
    ...
    //             initialValue: detail ? `${item.start_time} ~ ${item.end_time}` : '',
    //           })(
    //             <Input disabled/>
    //           )}
    //         </FormItem>
            ...
            <Col xs={24} sm={24} md={24} lg={14}>
              ...
              >
                ...
                <FormItem {...formItemLayout} label={`${title}介绍`} className={styles.ueditor}>
                  ...
                  })(<Ueditor content={detail.content} height={250} callback={this.editorCallback}/>)}
                </FormItem>
                ...
                <FormItem {...formItemLayout} label="列表展示图">
                  {getFieldDecorator('image', {
                    ...
                    <UploadImage defaultUrl={detail.image} callback={this.coverUploadCallback}/>
                  )}
                </FormItem>
                ...
                <FormItem {...formItemLayout} label="详情展示图">
                  {getFieldDecorator('image_details', {
                    ...
                    rules: [{required: true, message: '请选择展示图'}],
                  })(<UploadImage defaultUrl={detail.image_details} callback={this.detailUploadCallback}/>)}
                </FormItem>
