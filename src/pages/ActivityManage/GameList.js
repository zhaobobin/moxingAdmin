...
export default class GameList extends React.Component {
  ...
  addSecondActivity = item => {
    ...
    this.props.dispatch(routerRedux.push(`/activity/${path}/2_${item.type}_${item.id}`));
  };
...

      {
        ...
        render: (text, item) => (
          <span>
            ...
            {item.level === '1' ? (
              <a onClick={() => this.addSecondActivity(item)}>添加二级活动</a>
            ) : null}
            <Popconfirm
      ...
      [
        ...
        },
        {
          ...
          value: detail.start_ticket_time
            ? moment(detail.start_ticket_time * 1000).format('YYYY-MM-DD HH:mm:ss')
            : '',
          placeholder: '请选择',
          disabled: true,
          rules: [],
        },
        {
          ...
          value: detail.end_ticket_time
            ? moment(detail.end_ticket_time * 1000).format('YYYY-MM-DD HH:mm:ss')
            : '',
          placeholder: '请选择',
          disabled: true,
          rules: [],
