...
@Form.create()
export default class CreatePrize extends React.Component {
  constructor(props) {
    super(props);
    this.ajaxFlag = true;
    this.state = {
  ...
  handleFormSubmit = e => {
    ...
    this.props.form.validateFields('', (err, values) => {
      if (!err) {
        ...
        values.lucky = JSON.stringify(luckyForm);
  ...
  render() {
    ...
    const { detail, title, level, type, luckyForm } = this.state;
          ...
          <Row>
            <Col xs={24} sm={24} md={24} lg={14}>
              ...
              >
                ...
                <FormItem {...formItemLayout} label="邀请多少个用户可以抽奖">
                  {getFieldDecorator('invitation', {
                    initialValue: detail.invitation || '',
                ...
                <FormItem {...formItemLayout} label="每人抽奖次数上限">
                  {getFieldDecorator('limits', {
                    initialValue: detail.limits || '',
                    rules: [{ required: true, message: '请输入' }],
                  })(
                    <InputNumber
                      autoComplete="off"
